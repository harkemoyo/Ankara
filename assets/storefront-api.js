    ...
    if (orderMethod !== 'standard' && isWhatsAppEnabled()) {
        ...
        if (orderMethod === 'standard_plus_custom') {
            ...
            cta.innerHTML = `
                ...
                <a href="javascript:void(0)" onclick="window.openWhatsAppDirect('${phone}', '${encodedMsg}')" style="display:inline-flex;align-items:center;gap:0.6rem;text-decoration:none;color:#25d366;font-size:1.3rem;font-weight:600;cursor:pointer;">💬 Contact us on WhatsApp</a>
            `;
            ...
            cta.innerHTML = `
                ...
                <button onclick="window.openWhatsAppDirect('${phone}', '${encodedMsg}')" style="display:flex;align-items:center;justify-content:center;gap:0.6rem;background:#25d366;color:#fff;width:100%;padding:16px;border:none;border-radius:var(--radius,4px);font-size:1.5rem;font-weight:600;cursor:pointer;">
